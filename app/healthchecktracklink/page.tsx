...
const supabase = createClient(
  ...
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvbWtvbGhnbWt2c2h1Y3FqdWhmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQ2NTk2MzksImV4cCI6MjA2MDIzNTYzOX0.your-anon-key"
);
    ...
    <div className="min-h-screen bg-gray-100 text-sm">
      ...
      <nav className="bg-blue-900 text-white px-4 py-2 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <span className="text-xl font-bold tracking-widest">TRACKLINK<span className="text-yellow-400">«««</span></span>
